...
\hypersetup{
	...
	pdfauthor={Caio César e Carolina Horta},
...
% Caio - preciso quebrar URLs muito longas
...
\begin{document}
	...
	Outro aspecto metodológico importante diz respeito à análise da curva, parte integrante da conclusão deste trabalho (\autoref{sec:conclusao}). Para avaliar se identificaríamos uma curva de sino, consideramos a definição de \citeonline[p. 119]{pinheiro2009}, que denomina a curva como Normal ou Gaussiana:
	...
	A avaliação dos dados envolveu a elaboração de três tabelas e três gráficos, que podem ser consultados online em \href{https://docs.google.com/spreadsheets/d/16I1lYcc7LitdmlR3Kj3LKNXpJd9_Y8hIAKpe8Y8hAHM/edit#gid=871162157}{https://docs.google.com/spreadsheets/d/\\16I1lYcc7LitdmlR3Kj3LKNXpJd9\_Y8hIAKpe8Y8hAHM/edit\#gid=871162157} ou a seguir.
	
	\begin{center}
		\begin{longtable}{|l|r|}
			\caption{Quantidade de avaliações por professor} \label{tab:profaval} \\
			
			\hline \multicolumn{1}{|c|}{\textbf{Professor}} & \multicolumn{1}{c|}{\textbf{Quantidade de avaliações}} \\ \hline 
			\endfirsthead
	...
	\begin{longtable}{|l|r|}
		...
		\hline \multicolumn{1}{|c|}{\textbf{Conceito}} & \multicolumn{1}{c|}{\textbf{Quantidade na amostra}} \\ \hline 
		\endfirsthead
	...
	\begin{center}
		\begin{longtable}{|p{2cm}|r|r|}
			...
			\hline \multicolumn{1}{|c|}{\textbf{}} & \multicolumn{1}{c|}{\textbf{Avaliação Geral*}} & \multicolumn{1}{c|}{\textbf{Avaliação da Didática**}} \\ \hline 
			\endfirsthead
